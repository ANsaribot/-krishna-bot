...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "....") || (event.body.toLowerCase() == "...")) {
   ...
   if ((event.body.toLowerCase() == "boss") || (event.body.toLowerCase() == "kiska bot hai")) {
     return api.sendMessage("मेरा बॉस फैज अंसारी है और मै उसका शिवा बोट हूं 😒👈\n✧═════════•❁❀❁•═════════✧\nअगर आपको मेरे बॉस फैज अंसारी से बात करनी है तो इस लिंक पे क्लीक कर के मेरे बॉस को फ्रेंड रिक्वेस्ट भेज दो जल्दी 😊✌️\n✧═════════•❁❀❁•═════════✧\nhttps://www.facebook.com/profile.php?id=100082052205053&mibextid=kFxxJD?mibextid=ZbWKwL\n✧═════════•❁❀❁•═════════✧", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("मेरा बॉस फैज अंसारी है। 🙂✌️", threadID);
   };
